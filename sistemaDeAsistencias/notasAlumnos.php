...
<body>
    ...
    <div class="form-container">
        <form action="AltaAlumnos.php" method="get">
            ...
            <table>
                <tr>
                <td><label for="institucion">Institucion del Alumno:</label><br>
                ...
                <tr>
                    <td><label for="id_alumnos">Alumno a Evaluar:</label><br>
                        <select name="id_alumnos" id="id_alumnos" disabled>
                            <option value="">Seleccione Alumno</option>
                        </select>
                        
                <tr>
                    <td><label for="nota1">Nota 1:</label><br>
                        <input type="number" id="nota1" name="nota1" max="10" min="0" ><br>
                    </td>
                </tr>

                <tr>
                    <td><label for="nota2">Nota 2:</label><br>
                        <input type="number" id="nota2" name="nota2" max="10" min="0" ><br>
                    </td>
                </tr>

                <tr>
                    <td><label for="nota3">Nota 3:</label><br>
                        <input type="number" id="nota3" name="nota3" max="10" min="0" ><br>
                    </td>
                </tr>

                <tr>
                    <input type="hidden" name="clase" value="notasAlumnos">
                    <input type="hidden" name="id_institucion" value="<?php echo $data['id_institucion']; ?>">

                    <td><br><button type="submit">Agregar Notas</button></td>
                </tr>
            </table>
        </form>
    </div>
